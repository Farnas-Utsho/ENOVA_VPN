...
public class ListenersServerStatus  extends AppiumUtils implements ITestListener {
	AppiumDriver driver;
	ExtentTest test ;
    ...
    public void onTestFailure(ITestResult result) {
        ...
        try {
            ...
            java.lang.reflect.Field field = testClass.getClass().getDeclaredField("driver");
            field.setAccessible(true);

            driver = (AppiumDriver) field.get(testClass);

        } catch (Exception e) {
            System.out.println("⚠️ Driver fetch failed: " + e.getMessage());
        }
